...
impl LapHistoryData {
    fn from_2022(lh: &RawLapHistoryData) -> Result<LapHistoryData, UnpackError> {
        Ok(LapHistoryData {
...
impl TyreStintData {
    fn from_2022(ts: &RawTyreStintData) -> Result<TyreStintData, UnpackError> {
...
pub(crate) fn parse_session_history_data<T: BufRead>(
    ...
    let packet = PacketSessionHistoryData::from_2022(header, session_history_data)?;
