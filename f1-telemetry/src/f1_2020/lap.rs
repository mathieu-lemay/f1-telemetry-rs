...
impl LapData {
    fn from_2020(car_lap_data: &RawLapData) -> Result<Self, UnpackError> {
        ...
        Ok(Self::new(
            last_lap_time,
            current_lap_time,
            car_lap_data.sector_1_time,
            car_lap_data.sector_2_time,
            best_lap_time,
            car_lap_data.best_lap_num,
            car_lap_data.best_lap_sector_1_time,
            car_lap_data.best_lap_sector_2_time,
            car_lap_data.best_lap_sector_3_time,
            car_lap_data.best_overall_sector_1_time,
            car_lap_data.best_overall_sector_1_lap_num,
            car_lap_data.best_overall_sector_2_time,
            car_lap_data.best_overall_sector_2_lap_num,
            car_lap_data.best_overall_sector_3_time,
            car_lap_data.best_overall_sector_3_lap_num,
