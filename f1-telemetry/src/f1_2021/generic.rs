use crate::packet::generic::{Flag, Nationality, ResultStatus, Team};
...
pub(crate) fn unpack_team(value: u8) -> Result<Team, UnpackError> {
    match value {
        ...
        70 => Ok(Team::ArtGP2020),
        71 => Ok(Team::Campos2020),
        72 => Ok(Team::Carlin2020),
        73 => Ok(Team::Charouz2020),
        74 => Ok(Team::Dams2020),
        75 => Ok(Team::UniVirtuosi2020),
        76 => Ok(Team::MPMotorsport2020),
        77 => Ok(Team::Prema2020),
        78 => Ok(Team::Trident2020),
        79 => Ok(Team::BWT2020),
        80 => Ok(Team::Hitech2020),
