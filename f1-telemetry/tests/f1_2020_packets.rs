...
#[tokio::test]
async fn test_parse_2020_motion_packet() {
...
#[tokio::test]
async fn test_parse_2020_session_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_lap_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_event_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_participants_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_car_setups_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_car_telemetry_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_car_status_packet() {
    let stream = utils::get_stream().await;
    ...
    let expected = PacketCarStatusData {
        ...
        car_status_data: vec![
            ...
            CarStatusData {
                ...
                drs_status: DRS::NotAllowed,
                drs_activation_distance: Some(0),
                tyres_wear: Some(WheelData::new(1, 1, 1, 1)),
                actual_tyre_compound: TyreCompound::C4,
                visual_tyre_compound: TyreCompoundVisual::Soft,
                tyre_age_laps: Some(0),
                tyres_damage: Some(WheelData::new(1, 1, 1, 1)),
                front_left_wing_damage: Some(0),
                front_right_wing_damage: Some(0),
                rear_wing_damage: Some(0),
                drs_fault: Some(false),
            ...
            CarStatusData {
                ...
                drs_status: DRS::NotAllowed,
                drs_activation_distance: Some(0),
                tyres_wear: Some(WheelData::new(1, 0, 1, 0)),
                actual_tyre_compound: TyreCompound::C4,
                visual_tyre_compound: TyreCompoundVisual::Soft,
                tyre_age_laps: Some(0),
                tyres_damage: Some(WheelData::new(1, 0, 1, 0)),
                front_left_wing_damage: Some(0),
                front_right_wing_damage: Some(0),
                rear_wing_damage: Some(0),
                drs_fault: Some(false),
            ...
            CarStatusData {
                ...
                drs_status: DRS::NotAllowed,
                drs_activation_distance: Some(0),
                tyres_wear: Some(WheelData::new(1, 0, 0, 0)),
                actual_tyre_compound: TyreCompound::C4,
                visual_tyre_compound: TyreCompoundVisual::Soft,
                tyre_age_laps: Some(0),
                tyres_damage: Some(WheelData::new(1, 0, 0, 0)),
                front_left_wing_damage: Some(0),
                front_right_wing_damage: Some(0),
                rear_wing_damage: Some(0),
                drs_fault: Some(false),
...
#[tokio::test]
async fn test_parse_2020_final_classification_packet() {
    let stream = utils::get_stream().await;
...
#[tokio::test]
async fn test_parse_2020_lobby_info_packet() {
    let stream = utils::get_stream().await;
